...
#BSUB -n 1
#BSUB -W 48:00
#BSUB -J evaluation_rnn_hist_len_wo_att_40
...
python3 -m cache_replacement.policy_learning.cache.main \
  ...
  --experiment_name=evaluate_rnn_hist_len_wo_att_40\
  ...
  --config_bindings="eviction_policy.scorer.checkpoint=\"/share/$GROUP/$USER/GenAI-for-Systems-Gym/homework-1/models/RNN_without_Attention/experiments/rnn_hist_len_wo_att_40/checkpoints/20000.ckpt\"" \
  --config_bindings="eviction_policy.scorer.config_path=\"/share/$GROUP/$USER/GenAI-for-Systems-Gym/homework-1/models/RNN_without_Attention/experiments/rnn_hist_len_wo_att_40/model_config.json\"" \
  --warmup_period=0
