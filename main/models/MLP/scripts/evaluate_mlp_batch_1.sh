...
python3 -m cache_replacement.policy_learning.cache.main \
  ...
  --experiment_name=evaluate_mlp_batch_1 \
  ...
  --config_bindings="eviction_policy.scorer.checkpoint=\"/share/$GROUP/$USER/GenAI-for-Systems-Gym/homework-1/models/MLP/experiments/train_astar_mlp_batch_1/checkpoints/20000.ckpt\"" \
  --config_bindings="eviction_policy.scorer.config_path=\"/share/$GROUP/$USER/GenAI-for-Systems-Gym/homework-1/models/MLP/experiments/train_astar_mlp_batch_1/model_config.json\"" \
  --warmup_period=0
