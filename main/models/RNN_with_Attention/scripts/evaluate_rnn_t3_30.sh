...
python3 -m cache_replacement.policy_learning.cache.main \
  ...
  --experiment_name=evaluate_rnn_t3_30\
  ...
  --config_bindings="eviction_policy.scorer.checkpoint=\"/share/$GROUP/$USER/GenAI-for-Systems-Gym/homework-1/models/RNN_with_Attention/experiments/rnn_t3_30/checkpoints/20000.ckpt\"" \
  --config_bindings="eviction_policy.scorer.config_path=\"/share/$GROUP/$USER/GenAI-for-Systems-Gym/homework-1/models/RNN_with_Attention/experiments/rnn_t3_30/model_config.json\"" \
  --warmup_period=0
